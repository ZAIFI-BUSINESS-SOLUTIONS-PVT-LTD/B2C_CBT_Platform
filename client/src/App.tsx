...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/institution-admin-dashboard" component={InstitutionAdminDashboard} />
      <Route path="/institution-admin/analytics" component={InstitutionStudentAnalytics} />
      <Route path="/institution/pyq-upload" component={PYQUpload} />
      ...
      <Route path="/pyqs" component={requirePhoneNumber(PYQs)} />
      ...
      <Route path="/delete-account" component={DeleteAccount} /> {/* Delete account informational page */}
