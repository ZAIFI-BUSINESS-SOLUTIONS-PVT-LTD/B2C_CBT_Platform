...
export default function LoginPage() {
    ...
    return (
        <>
            ...
            <div className="min-h-screen w-full flex items-end justify-center relative overflow-hidden md:hidden" style={{ backgroundImage: "url('/login-bg.webp')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                {/* Penguin mascot positioned near top-center of viewport */}
                <img src="/penguin_welcome.webp" alt="Login mascot" className="absolute top-14 left-1/2 w-28 sm:w-32 pointer-events-none mt-32" style={{ transform: 'translateX(-50%) scale(2.0)' }} />
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 text-center w-11/12 max-w-2xl" style={{ top: '50%' }}>
                    <h1 className="text-xl sm:text-3xl md:text-2xl font-semibold leading-tight" style={{ color: '#162a43', fontSize: '150%' }}>
                        <span className="block">Stuck at the Same</span>
                        <span className="block">NEET Score?</span>
                    </h1>
                    <p className="mt-2 text-xs sm:text-sm" style={{ color: '#4a5965' }}>Find your weak topics and improve after each test.</p>
                </div>
            ...
            <div className="hidden md:flex min-h-screen w-full items-center justify-center relative" style={{ backgroundImage: `url(${Login})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <img src="/login-penguin.webp" alt="Login mascot" className="absolute top-20 left-1/2 w-36 pointer-events-none opacity-95" style={{ transform: 'translateX(-50%) scale(1.5)' }} />
                ...
                {/* Desktop headline + subtext */}
                    ...
                    <h1 className="text-3xl lg:text-4xl font-semibold leading-tight" style={{ color: '#233a56', fontSize: '120%' }}>
