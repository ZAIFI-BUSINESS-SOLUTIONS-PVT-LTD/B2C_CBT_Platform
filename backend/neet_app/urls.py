...
from .views.institution_analytics_views import (
    list_institution_students, get_student_performance, download_student_questions
)
...
from .views.qod_views import get_question_of_the_day, submit_question_of_the_day
from .views.question_feedback_views import submit_question_feedback, get_question_feedback
...
urlpatterns = [
    ...
    path('qod/', get_question_of_the_day, name='get-question-of-the-day'),
    path('qod/submit/', submit_question_of_the_day, name='submit-question-of-the-day'),
    
    # Question Feedback endpoints
    path('question-feedback/', submit_question_feedback, name='submit-question-feedback'),
    path('question-feedback/list/', get_question_feedback, name='get-question-feedback'),
    ...
    # Student insights endpoints removed — related functionality deprecated
    ...
    # Institution Analytics endpoints (student performance dashboard)
    path('institution-admin/analytics/students/', list_institution_students, name='institution-admin-students-list'),
    path('institution-admin/analytics/students/<str:student_id>/performance/', get_student_performance, name='institution-admin-student-performance'),
    path('institution-admin/analytics/students/<str:student_id>/download/', download_student_questions, name='institution-admin-student-download'),
